...
_ENABLED: Final[bool] = os.getenv("K100AI_NATIVE_INT8_MOE", "0") == "1"
_MAX_NATIVE_M: Final[int] = int(os.getenv("K100AI_NATIVE_INT8_MOE_MAX_M", "32"))
...
_K100AI_HCU_ALIGN_FASTPATH: Final[bool] = os.getenv("K100AI_HCU_ALIGN_FASTPATH", "0") == "1"
if _K100AI_HCU_ALIGN_FASTPATH:
    try:
        ...
        def _k100_hcu_update_states_after_model_execute(
            ...
            if dbg < 8:
                print(
                    f"[K100AI R195 align decision] fast={fast_ok} reason={reason} "
            ...
            # postprocess_mamba.
            if not globals().get("_K100AI_HCU_GPU_ACCEPT_FASTPATH", False):
        ...
        print(
            "[K100AI R195 HCU align fast-path] installed on vllm_hcu GPUModelRunner",
            flush=True,
        )
    except Exception as _k100_hcu_align_exc:
        print(
            f"[K100AI R195 HCU align fast-path] disabled: {_k100_hcu_align_exc!r}",
            flush=True,
        )
...
_K100AI_HCU_GPU_ACCEPT_FASTPATH: Final[bool] = os.getenv(
    "K100AI_HCU_GPU_ACCEPT_FASTPATH", "0"
) == "1"
if _K100AI_HCU_GPU_ACCEPT_FASTPATH:
    try:
        ...
        def _r197_build_attention_metadata(self, *args, **kwargs):
            ...
            try:
                ...
                if count == 1:
                    print(
                        "[K100AI R197 GPU accepted-token metadata] first direct-GPU step",
                        flush=True,
                    )
                return _r197_prev_build(self, *args, **kwargs)
            finally:
        ...
        print(
            "[K100AI R197 GPU accepted-token metadata] installed",
            flush=True,
        )
    except Exception as _r197_exc:
        print(
            f"[K100AI R197 GPU accepted-token metadata] disabled: {_r197_exc!r}",
            flush=True,
        )
